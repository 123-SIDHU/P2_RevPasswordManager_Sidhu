...
public class SecurityConfig {
    ...
    private final com.rev.app.config.CustomAuthenticationSuccessHandler successHandler;
    private final JwtAuthenticationFilter jwtAuthFilter;

    public SecurityConfig(UserDetailsServiceImpl userDetailsService,
                          com.rev.app.config.CustomAuthenticationSuccessHandler successHandler,
