...
public class UserServiceImpl implements IUserService {
    ...
    public void preValidateRegistration(RegisterDTO dto) {
        ...
        if (IUserRepository.existsByUsername(dto.getUsername())) {
    ...
    public User findByUsernameOrEmail(String usernameOrEmail) {
        return IUserRepository.findByUsernameOrEmail(usernameOrEmail, usernameOrEmail)
    ...
    public User updateProfile(Long userId, ProfileUpdateDTO dto) {
        ...
        if (dto.isRemovePhoto()) {
            user.setProfilePhotoUrl(null);
        } else if (dto.getProfilePhoto() != null && !dto.getProfilePhoto().isEmpty()) {
            try {
